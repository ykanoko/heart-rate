...
with open(txt_dir + data_date + data_type + '.txt', 'r') as f:
    file_names = ["2309S10_2.csv", "2309S9_6.csv"]
...
for file_name in file_names:
    ...
    print('df_csv.values.tolist()', df_csv.values.tolist())

    wb.save(output_file)

    print('input_file : ', input_file_name, 'output_file : ', output_file, 'sheet_name : ', sheet_name)
